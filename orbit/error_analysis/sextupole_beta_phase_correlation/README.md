...
julia --project=. `
  'orbit/error_analysis/sextupole_beta_phase_correlation/export_nominal_optics.jl' `
  --ring=latest --output-dir='orbit/error_analysis/sextupole_beta_phase_correlation/smoke/latest_cesr'
julia --project=. `
  'orbit/error_analysis/sextupole_beta_phase_correlation/export_direction_optics.jl' `
  --ring=latest --trials=2 --output-dir='orbit/error_analysis/sextupole_beta_phase_correlation/smoke/latest_cesr'
```
...
& 'C:\Users\JoeyN\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' `
  'orbit/error_analysis/sextupole_beta_phase_correlation/analyze_beta_phase_correlation.py' `
  --optics 'orbit/error_analysis/sextupole_beta_phase_correlation/smoke/latest_cesr/nominal_optics_points.csv' `
  --optics-metadata 'orbit/error_analysis/sextupole_beta_phase_correlation/smoke/latest_cesr/nominal_optics_metadata.toml' `
  --direction-optics 'orbit/error_analysis/sextupole_beta_phase_correlation/smoke/latest_cesr/direction_optics_points.csv' `
  --direction-tunes 'orbit/error_analysis/sextupole_beta_phase_correlation/smoke/latest_cesr/direction_optics_tunes.csv' `
  --contributions 'orbit/error_analysis/sextupole_detector_contributions/smoke/latest_cesr/sextupole_direction_contributions.csv' `
  --closure 'orbit/error_analysis/sextupole_detector_contributions/smoke/latest_cesr/direction_closure.csv' `
  --output-dir 'orbit/error_analysis/sextupole_beta_phase_correlation/smoke/latest_cesr'
```
