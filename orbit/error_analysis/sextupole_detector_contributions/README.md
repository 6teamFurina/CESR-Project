...
julia --project=. `
  'orbit/error_analysis/sextupole_detector_contributions/run_sextupole_detector_contributions.jl' `
  --ring=latest --trials=2 `
  --output-dir='orbit/error_analysis/sextupole_detector_contributions/smoke/latest_cesr'
```
...
julia --project=. `
  ...
  --output-dir='orbit/error_analysis/sextupole_detector_contributions/results/latest_cesr'
```
