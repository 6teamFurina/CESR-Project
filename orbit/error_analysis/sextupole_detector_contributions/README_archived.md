...
```powershell
julia --project=. orbit/error_analysis/sextupole_detector_contributions/run_sextupole_detector_contributions.jl
python orbit/error_analysis/sextupole_detector_contributions/analyze_sextupole_detector_contributions.py
```
