...
const REFERENCE = joinpath(@__DIR__, "bmad_girder_reference", "tracking_response.csv")
const OUTPUT = joinpath(@__DIR__, "scibmad_girder_tracking_comparison.csv")
const SUMMARY = joinpath(@__DIR__, "GIRDER_VALIDATION.md")
