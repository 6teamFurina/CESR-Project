...
const REFERENCE_DIR = joinpath(BMAD_REFERENCE_DIR, "control_tracking")
...
const OUTPUT_CSV = joinpath(SCIBMAD_VALIDATION_DIR, "scibmad_control_tracking_comparison.csv")
const SUMMARY = joinpath(SCIBMAD_VALIDATION_DIR, "FULL_CONTROL_VALIDATION.md")
