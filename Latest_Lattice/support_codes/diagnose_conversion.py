...
RAW_EXPORT = REFERENCE_DIR / "raw_exports" / "latest_cesr_scibmad_bmad_20260814.jl"
WRITE_LOG = REFERENCE_DIR / "raw_exports" / "tao_write_scibmad_bmad_20260814.log"
...
def main() -> None:
    ...
    write_csv(
        INVENTORY_DIR / "bmad_branches.csv",
        branches,
        ["branch", "branch_name", "n_ele_track", "n_ele_max"],
    )
    write_csv(
        INVENTORY_DIR / "bmad_element_inventory.csv",
        elements,
        [
            "branch",
            "branch_name",
    ...
    write_csv(
        INVENTORY_DIR / "bmad_control_lords.csv",
        lords,
        ["element_id", "name", "key", "control_variables"],
    )
    write_csv(
        INVENTORY_DIR / "bmad_control_relations.csv",
        relations,
        [
            "lord_id",
            "lord_name",
    ...
    (INVENTORY_DIR / "conversion_inventory.json").write_text(
