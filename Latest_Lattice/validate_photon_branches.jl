...
const BRANCH_CSV = joinpath(@__DIR__, "bmad_branches.csv")
const INVENTORY_CSV = joinpath(@__DIR__, "bmad_element_inventory.csv")
const SUMMARY = joinpath(@__DIR__, "PHOTON_BRANCH_VALIDATION.md")
