...
julia --project=. optics/benchmark_scibmad_chromatic_optics.jl `
  --sample-count=1000 `
  --twiss-mode=fresh `
  --output-dir=optics/results/methods_1000/scibmad_pointwise

julia --project=. optics/benchmark_scibmad_chromatic_optics.jl `
  --sample-count=1000 `
  --twiss-mode=reuse `
  --output-dir=optics/results/methods_1000/scibmad_twiss_reuse
```
...
julia --project=. optics/benchmark_scibmad_parameterized_twiss.jl `
  --sample-count=1000 `
  --phase-space-order=3 `
  --output-dir=optics/results/methods_1000/scibmad_parameterized_order3
```
...
python optics/benchmark_bmad_optics.py \
  --sample-count=1000 \
  --delta-step=1e-5 \
  --output-dir=optics/results/bmad_chromatic_fixed_1000
```
