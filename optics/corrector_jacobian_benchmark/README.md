...
julia --project=. optics/corrector_jacobian_benchmark/benchmark_scibmad_corrector_jacobian.jl
```
...
python optics/corrector_jacobian_benchmark/benchmark_bmad_corrector_jacobian.py
```

Then compare the labeled matrices:

```powershell
python optics/corrector_jacobian_benchmark/compare_corrector_jacobians.py
```

For the completed 225-parameter extended case:

```powershell
python optics/corrector_jacobian_benchmark/compare_extended_jacobians.py
```

For the one-parameter-per-corrector comparison:

```powershell
python optics/corrector_jacobian_benchmark/compare_per_corrector_jacobians.py
```
