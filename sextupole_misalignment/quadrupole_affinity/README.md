...
julia --startup-file=no --project='CESR Project' `
  'CESR Project/sextupole_misalignment/quadrupole_affinity/generate_scibmad_affinity_responses.jl' `
  --stage=screen
...
```powershell
python 'CESR Project/sextupole_misalignment/quadrupole_affinity/analyze_affinity.py'
python 'CESR Project/sextupole_misalignment/quadrupole_affinity/render_affinity_heatmaps.py'
python 'CESR Project/sextupole_misalignment/quadrupole_affinity/select_greedy_quadrupole_sets.py'
python 'CESR Project/sextupole_misalignment/quadrupole_affinity/validate_greedy_quadrupole_selection.py'
python 'CESR Project/sextupole_misalignment/quadrupole_affinity/select_best_quadrupole_triplets.py'
python 'CESR Project/sextupole_misalignment/quadrupole_affinity/validate_quadrupole_triplet_selection.py'
```
