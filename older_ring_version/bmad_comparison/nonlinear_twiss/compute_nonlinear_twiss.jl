    ...
    open(path, "w") do io
        ...
        for i in eachindex(table.s)
            row = (
                ...
                constant_term(table.orbit_x[i]),
                constant_term(table.orbit_px[i]),
                constant_term(table.orbit_y[i]),
                constant_term(table.orbit_py[i]),
                constant_term(table.orbit_z[i]),
                constant_term(table.orbit_pz[i]),
                tune_1,
                tune_2,
                xi_1,
                xi_2,
