...
- SciBmad lattice: `older_ring_version/cesr.jl`, loaded with `load_cesr()` and enabled with
...
julia --project=. older_ring_version/test_codes/test_bmad_scibmad.jl \
  --rf-on \
  --reference=older_ring_version/bmad_comparison/bmad_optics_outputs/bmad_reference_rf_on_output.tar.gz \
  --csv=older_ring_version/bmad_comparison/optic_maps_rf_on/bmad_scibmad_rf_on_comparison.csv

julia --project=. older_ring_version/bmad_comparison/optic_maps_rf_on/compare_rf_on_optics.jl
```
