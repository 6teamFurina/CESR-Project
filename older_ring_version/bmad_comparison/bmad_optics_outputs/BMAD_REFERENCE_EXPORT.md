...
- `older_ring_version/bmad_comparison/bmad_optics_outputs/run_bmad_reference.sh`
- `older_ring_version/bmad_comparison/bmad_optics_outputs/export_bmad_reference.py`
- `older_ring_version/cesr.bmad`

From the CESR project root in a Windows PowerShell prompt, not from inside the
SSH session, one possible copy command is:

    scp older_ring_version/bmad_comparison/bmad_optics_outputs/run_bmad_reference.sh older_ring_version/bmad_comparison/bmad_optics_outputs/export_bmad_reference.py older_ring_version/cesr.bmad jn577@lnx201.classe.cornell.edu:/home/jn577/cesr_scibmad/
...
Run this from Windows PowerShell:
    ...
    scp jn577@lnx201.classe.cornell.edu:/home/jn577/cesr_scibmad/bmad_reference_rf_off_output.tar.gz older_ring_version/bmad_comparison/bmad_optics_outputs/
...
From the repository root on the machine with Julia and SciBmad installed:
    ...
    julia --project=. older_ring_version/test_codes/test_bmad_scibmad.jl
...
`older_ring_version/bmad_comparison/optic_maps_rf_off/bmad_scibmad_rf_off_comparison.csv`.

For a quick archive check or a short smoke test, use:

    julia --project=. older_ring_version/test_codes/test_bmad_scibmad.jl --parse-only
    julia --project=. older_ring_version/test_codes/test_bmad_scibmad.jl --max-elements=10
