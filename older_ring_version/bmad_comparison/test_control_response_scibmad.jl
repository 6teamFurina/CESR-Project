...
Run from the CESR Project directory:
    ...
    julia --project=. older_ring_version/bmad_comparison/test_control_response_scibmad.jl --mode=rf_on
    julia --project=. older_ring_version/bmad_comparison/test_control_response_scibmad.jl --mode=rf_off
