...
```powershell
julia --project=. dataset_benchmark\optics\sextupole_alignment_gtpsa\sextupole_excitation_validity_envelope\generate_exact_local_orbit_validation.jl --targets=all --overwrite=true
julia --project=. dataset_benchmark\optics\sextupole_alignment_gtpsa\sextupole_excitation_validity_envelope\generate_gtpsa_local_orbit_map.jl --target=SEX_09AW
python dataset_benchmark\optics\sextupole_alignment_gtpsa\sextupole_excitation_validity_envelope\analyze_validity_envelope.py
python dataset_benchmark\optics\sextupole_alignment_gtpsa\sextupole_excitation_validity_envelope\validate_results.py
```
