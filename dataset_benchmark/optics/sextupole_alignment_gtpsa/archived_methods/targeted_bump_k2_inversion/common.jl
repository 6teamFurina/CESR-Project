...
const ARCHIVED_METHODS_DIR = normpath(joinpath(INVERSION_HERE, ".."))
const ALIGNMENT_STUDY_DIR = normpath(joinpath(ARCHIVED_METHODS_DIR, ".."))
const PROJECT_DIR = normpath(joinpath(INVERSION_HERE, "..", "..", "..", "..", ".."))
const RESPONSE_MAP_DIR = joinpath(ARCHIVED_METHODS_DIR, "response_map")
