...
```powershell
julia --project=. dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/build_local_bump_knobs.jl `
  --targets=SEX_08W
```
...
```powershell
julia --project=. dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/run_exact_scan.jl `
  --target=SEX_08W `
...
```powershell
python dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/invert_scan.py
```
...
```powershell
python dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/validate_smoke_results.py
```
...
```powershell
julia --project=. dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/generate_conditioned_inverse_models.jl

& 'C:\Users\JoeyN\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' `
  dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/benchmark_physical_inverses.py

julia --project=. dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/run_exact_p3_inverse.jl

& 'C:\Users\JoeyN\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' `
  dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/validate_paired_benchmark.py
```
...
julia --project=. dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/generate_conditioned_inverse_models.jl `
  ...
  --output-dir=dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/results/unknown_background_benchmark/nominal_models

& 'C:\Users\JoeyN\.cache\codex-runtimes\codex-primary-runtime\dependencies\python\python.exe' `
  dataset_benchmark/optics/sextupole_alignment_gtpsa/archived_methods/targeted_bump_k2_inversion/benchmark_nonlinear_p2b.py
```
