...
```console
python dataset_benchmark/orbit/Orbit_Calculation/generate_control_samples.py
```
...
julia --threads=auto --project=. \
  dataset_benchmark/orbit/Orbit_Calculation/benchmark_scibmad.jl
```
...
```console
python dataset_benchmark/orbit/Orbit_Calculation/benchmark_bmad.py
```
...
```console
python dataset_benchmark/orbit/Orbit_Calculation/compare_outputs.py
```
