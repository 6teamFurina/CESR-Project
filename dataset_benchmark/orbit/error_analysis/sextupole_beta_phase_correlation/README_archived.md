...
```powershell
julia --project=. dataset_benchmark/orbit/error_analysis/sextupole_beta_phase_correlation/export_nominal_optics.jl
julia --project=. dataset_benchmark/orbit/error_analysis/sextupole_beta_phase_correlation/export_direction_optics.jl
python dataset_benchmark/orbit/error_analysis/sextupole_beta_phase_correlation/analyze_beta_phase_correlation.py
```
