...
```console
julia --project=. dataset_benchmark/orbit/error_analysis/vertical_parity/run_vertical_parity_experiment.jl
python dataset_benchmark/orbit/error_analysis/vertical_parity/analyze_vertical_parity.py \
  dataset_benchmark/orbit/error_analysis/vertical_parity/results/vertical_parity_summary.csv
```
